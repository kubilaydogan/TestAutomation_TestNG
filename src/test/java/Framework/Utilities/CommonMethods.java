...
public class CommonMethods extends CoreObjects {
    ...
    public void selectFromDropdownByVisibleText(By by, String visibleText) {
        Select dropdown = new Select(wait.until(ExpectedConditions.visibilityOfElementLocated(by)));
    ...
    public WebElement waitFor(ExpectedCondition<WebElement> condition) {
